...
import com.umc.hugo.user.model.GetUserRes;
import com.umc.hugo.user.model.PatchUserReq;
import com.umc.hugo.user.model.PostLoginReq;
import com.umc.hugo.user.model.PostUserReq;
...
public class UserDao {
    ...
    public User getPwd(PostLoginReq postLoginReq) {
        String getPwdQuery = "select userIdx, name, email, password, profileImgUrl from User where email = ?"; // 해당 email을 만족하는 User의 정보들을 조회한다.
